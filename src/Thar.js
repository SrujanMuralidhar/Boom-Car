  ...
  constructor(){
    ...
    render(){
        return (
            ...
            <h1 class="margin_left heading_details">Mahindra Thar</h1>
            <div class="card_car_details">
            <div class="align_center">
                
                        <img src="https://images.91wheels.com//assets/b_images/main/models/profile/profile1660712825.png" class="d-block w-100 car_height_carousel" alt="..."></img>
                        <img src="https://i.ytimg.com/vi/nvgkb2BRjsg/maxresdefault.jpg" class="d-block w-100 car_height_carousel" alt="..."></img>

                <table class="table car_text_details">
                    <thead>
                      <tr>
                        <th scope="col">Engine:</th>
                        <td scope="col">Engine Displacement(cc): 3.3L</td>
